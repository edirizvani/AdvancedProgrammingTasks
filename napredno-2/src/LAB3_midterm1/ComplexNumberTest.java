...
//    private U imaginary;
//
//    public ComplexNumber(T real, U complex) {
//        this.real = real;
...
//        String realStr = String.format("%.2f", real.doubleValue());
//        String imagStr = String.format("%.2f", imaginary.doubleValue());
//        return imagStr.startsWith("-") ? realStr + imagStr + "i" : realStr + "+" + imagStr + "i";
//    }
//}
//
//
