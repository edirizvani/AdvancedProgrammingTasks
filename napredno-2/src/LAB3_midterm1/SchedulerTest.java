...
//        return String.format(time.toString()+" "+element);
//    }
//
//    @Override
...
//        Timestamp<T> closerToNow=null;
//        for (Timestamp<T> tim:list){
//            if(tim.getTime().isAfter(now)){
//                if(closerToNow==null || tim.getTime().isBefore(closerToNow.getTime())){
//                    closerToNow=tim;
//                }
//            }
//        }
...
//        Timestamp<T> closerToNow=null;
//        for (Timestamp<T> tim:list){
//            if(tim.getTime().isBefore(now)){
//                if(closerToNow==null || tim.getTime().isAfter(closerToNow.getTime())){
//                    closerToNow=tim;
//                }
//            }
//        }
...
//        List<Timestamp<T>> times=new ArrayList<>();
//        for (Timestamp<T> tim:list){
//            if(tim.getTime().isBefore(end) && tim.getTime().isAfter(begin)){
//                times.add(tim);
//            }
//        }
//        return times;
