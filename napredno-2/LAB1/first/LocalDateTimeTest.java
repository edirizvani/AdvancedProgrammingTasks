...
public class LocalDateTimeTest {
    ...
    static LocalDateTime localTimeWith() {
        ...
        return ldt.withDayOfMonth(1).plusMonths(1).truncatedTo(ChronoUnit.HOURS);
    }
    ...
    static String localDateTimeFormat() {
         ...
         */
        DateTimeFormatter formater=DateTimeFormatter.ofPattern("yyyy_MM_dd_HH_mm_ss");
        return ldt.format(formater);
    }
